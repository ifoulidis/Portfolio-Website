    ...
    <div className="container">
      ...
      <div id="content">
          ...
          <ul>
            ...
            <li>Versitility of web development skills.</li>
          ...
          <p>The map has two layers: one shows the positions of volcanoes in the US (colour coded according to their evelation), and some information about them; the other color codes countries by their populations. You can see the fullscreen page by clicking <Link href="/map1.html">here.</Link></p>
