      ...
      <div className="container">
        <div id="content">
          <div className="icon_container">
            ...
            <Link href="./other_projects/border_crossing">
              <a>
                <Image alt="icon" src={CSharpIcon} height={32} width={32} />
              </a>
            </Link>
          </div>
          <br></br>
          ...
          <p>
            My degree is in biochemistry, but afterward, I became a hobbyist
            developer and have acquired skills in a number fields of
            programming.
          </p>
          <p>
            Please take a look at some of the projects I have completed.
